...
# You may obtain a copy of the License me
#
...
# Always cd to the directory containing this script.
cd "$CASE_DIR"
...
# Use the maximum available byte code version of the running JVM.
...
# Collect all arguments for the java command, following the bash shell script and
# standard convention for ARGS.
